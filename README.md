...
- [jut](https://github.com/kracekumar/jut) - CLI to view head/tail of notebooks in terminals.
- [Kapitsa](https://github.com/gitjeff05/kapitsa) - CLI to search local Jupyter notebooks.
- [nbconvert](https://nbconvert.readthedocs.io) - Convert Notebooks to other formats.ter notebook in the terminal.
