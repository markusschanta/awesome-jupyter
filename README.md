...
- [Jupyter Notebook Validator Operator](https://github.com/tosin2013/jupyter-notebook-validator-operator) - Kubernetes operator that validates notebooks against golden baselines and model endpoints.
