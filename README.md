...
- [jupyter-panel-proxy](https://github.com/holoviz/jupyter-panel-proxy) - Extension to automatically serve notebooks as Panel data apps at the `/panel` endpoint of your Jupyter server.
