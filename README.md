...
- [jupyter-panel-proxy](https://github.com/holoviz/jupyter-panel-proxy) - Will automatically serve notebooks as Panel data apps at the `/panel` endpoint of your Jupyter server.
