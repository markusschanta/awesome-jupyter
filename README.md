...
- [jupyter-shopsavvy](https://github.com/shopsavvy/jupyter-shopsavvy) - Magic commands for product search, price comparison, and price history charts using the ShopSavvy API.
