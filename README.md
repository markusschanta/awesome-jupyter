...
- [Panel](https://github.com/holoviz/panel) - Create interactive tools and data apps from Jupyter Notebooks. Can be distributed as server apps, client side apps (via pyodide) or static HTML/ JavaScript files.
